                    ...
                    <form id="orderForm" action="CreateOrderServlet" method="post">
                        ...
                        $(document).ready(function () {
                            ...
                            $("#search").on("focus", function () {
                                ...
                                <input type="hidden" name="orderType" value="0"><!-- nhập -->
...
// Kiểm tra xem có thông báo thành công hay không
                                ...
                                <div class="payment-options">
                                    ...
                                    <div class="info-row">
                                        <span class="info-label">Cửa Hàng Thanh Toán:</span>
                        ...
                        <script>
                            function addProductToOrder(productID, productName, unitSizes) {
                                ...
                                cell2.innerHTML = '<input type="number" name="quantity" class="quantity" required="required" value="1" min="1">';
                                cell5.innerHTML = '<input type="hidden" name="unitPriceHidden" class="unitPriceHidden">' +
                                ...
                                var unitPriceInput = cell5.querySelector('.unitPrice');
                            ...
                            function recalculateRow(row) {
                                ...
                                var totalPrice = (totalWeight * unitPriceHidden.value) || 0;
