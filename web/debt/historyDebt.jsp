                                ...
                                <tr class="no-rows">
                                    ...
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:when test="${o.getPaymentStatus() == 1}">Khách hàng trả nợ</c:when>
                                            <c:when test="${o.getPaymentStatus() == 2}">Cửa hàng đi vay</c:when>
                                            <c:when test="${o.getPaymentStatus() == 3}">Cửa hàng đi trả</c:when>
                            ...
                            <tr class="newDebt-tableTbody-tr">
                                ...
                                <td >
                                    <select name="typeDebt" class="newDebt-input" required>
                                        ...
                                        <option value="1">Khách hàng trả nợ</option>
                                        <option value="2">Cửa hàng đi vay</option>
                                        <option value="3">Cửa hàng đi trả</option>
                                    </select>
                                </td>   
                            </tr>  
