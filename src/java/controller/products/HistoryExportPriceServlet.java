...
public class HistoryExportPriceServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        HistoryList = DAOProduct.INSTANCE.getExportPriceHistory(keyword, currentPage, recordsPerPage, userId, sortOrder);

        // Lấy tổng số bản ghi để tính tổng số trang
        int totalRecords = DAOProduct.INSTANCE.getTotalHistoryExportRecords(keyword, userId); // Truyền keyword + userId vào
