...
public class DAOProduct extends DBContext {
    ...
    public int updateProduct(products product) {
        ...
        try {
            ...
            pre.setString(8, product.getCreateBy());
            pre.setInt(9, product.getIsDelete());
            pre.setString(10, product.getDeleteAt());
            pre.setString(11, product.getDeleteBy());
...
//        products newProduct = new products( "Sản phẩm D", "Mô tả sản phẩm A", 100.0, 10, "imageA.jpg", "2023-01-01", "2023-01-01", "1", 0, null, null);
//        int insertResult = dao.insertProduct(newProduct);
//        System.out.println("Insert result: " + insertResult);

//        // 2. Cập nhật thông tin sản phẩm
//        products productToUpdate = new products(2, "Sản phẩm B Phụ", "Mô tả sản phẩm B", 150.0, 20, "imageB.jpg", "2023-01-02", "2023-01-02", "1", 0, null, null);
